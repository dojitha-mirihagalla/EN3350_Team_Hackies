...
const Quiz = ({questions,Questions}) => {
    ...
    useEffect(() => {
      ...
      const postBooleanToFirebase = async (booleanValue) => {
        try {
          const databaseURL = 'https://teamhackiesdb-default-rtdb.asia-southeast1.firebasedatabase.app/'+username+'/Quiz/'+'isQuizDone.json'; // Replace with your Firebase Realtime Database URL
      ...
      const postResulteToFirebase = async (value) => {
        try {
          const databaseURL = 'https://teamhackiesdb-default-rtdb.asia-southeast1.firebasedatabase.app/'+username+'/Quiz/'+'score.json'; // Replace with your Firebase Realtime Database URL
